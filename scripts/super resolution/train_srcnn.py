...
train_data = torch.load(f"C:/Users/drozd/Documents/programming stuff/Python Programms/SPUR/super resolution/data/training_50s.pt")
test_data = torch.load(f"C:/Users/drozd/Documents/programming stuff/Python Programms/SPUR/super resolution/data/validation_50s.pt")
...
for i in range(EPOCHS):
    ...
    torch.save(model.state_dict(), f"srcnn.pt")
print("[INFO] Done! :D")
